...
# dependencies = ["pyyaml"]
# ///
"""SessionEnd workflow - orchestrates cleanup when session ends.

ARCHITECTURE: Thin orchestrator that composes lifecycle hooks from lifecycle/ directory.

Orchestrates:
  - lifecycle/export_conversation.py - Exports conversation transcript
  - Session logging to ~/.claude/logs/session_YYYYMMDD.jsonl
...
Exit codes:
  0 = Success (SessionEnd cannot block termination)
