...
# ///
"""PreToolUse workflow - orchestrates safety guards before tool execution.
...
Orchestrates:
  ...
  - guards/secret_scanner.py - Detects potential secrets in code
  - guards/large_file_guard.py - Warns about large file operations
  - guards/path_validation.py - Validates file paths
  - guards/readonly_guard.py - Protects auto-generated files
...
This workflow should remain < 150 lines. Complex logic belongs in guards/.
"""
