...
---
name: performance
description: Use this agent when optimizing applications. Specializes in performance analysis, optimization, and monitoring. Examples: <example>Context: User has slow app user: 'My app is running slowly' assistant: 'I'll use the performance agent to analyze and optimize your application' <commentary>Performance issues require specialized optimization expertise</commentary></example>
color: blue
---
