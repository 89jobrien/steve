---
allowed-tools: Skill(vector-database), Skill(context-management), Read, Write, Edit,
  Bash, Grep, Glob
argument-hint: ' [project-identifier] | [restoration-mode] | [token-budget] | [relevance-threshold]'
description: Restore context from vector database, file system, or other sources.
