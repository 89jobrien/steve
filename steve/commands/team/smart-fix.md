---
allowed-tools: Skill(smart-debug), Skill(debugger), Skill(code-reviewer), Skill(python-pro),
  Skill(typescript-pro), Read, Write, Edit, Bash, Grep, Glob
argument-hint: ' [issue-id]'
description: Resolve GitHub issues systematically, from triage to deployment, using
  specialized agents for investigation, implementation, and verification.
