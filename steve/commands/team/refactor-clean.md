---
allowed-tools: Read, Write, Edit, Bash, Grep, Glob, Skill(code-review), Skill(ai-code-cleanup)
argument-hint: ' [file-path] | [commit-hash] | full'
description: Refactor and clean code to improve its quality, maintainability, and
  performance.
