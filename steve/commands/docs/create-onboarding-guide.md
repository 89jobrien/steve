...
argument-hint: '[type] | --developer | --designer | --devops | --comprehensive | --interactive'
description: Create comprehensive developer onboarding guides with environment setup,
  workflows, and interactive tutorials
...
- Project setup: @package.json or @pyproject.toml or @Cargo.toml (detect tech stack)
...
- CI/CD setup: !`find .github/workflows -name "*.yml" -o -name "*.yaml" | head -3`
