...
description: Comprehensive architecture review with design patterns analysis and improvement
  recommendations
...
- Package dependencies: !`[ -f package.json ] && echo "Node.js project" || [ -f pyproject.toml ] && echo "Python project" || [ -f go.mod ] && echo "Go project" || echo "Multiple languages"`
