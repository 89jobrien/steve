...
description: Create production-ready Dockerfile with multi-stage builds, security
  hardening, and optimization (use /setup:setup-docker-containers for dev environment)
