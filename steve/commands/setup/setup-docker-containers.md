...
description: Setup Docker development environment with docker-compose, volumes, and dev workflows (use /dev:containerize-application for production Dockerfiles)
---
